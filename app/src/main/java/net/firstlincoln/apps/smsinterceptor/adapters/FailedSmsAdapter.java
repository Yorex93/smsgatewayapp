...
public class FailedSmsAdapter extends RecyclerView.Adapter<FailedSmsAdapter.ViewHolder> {
    ...
    public FailedSmsAdapter(List<SmsEntity> sms, OnItemClickListener listener){
        this.sms = sms;
        this.listener = listener;
    }

    @Override
    public FailedSmsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.failed_sms_list_row, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(FailedSmsAdapter.ViewHolder holder, int position) {
